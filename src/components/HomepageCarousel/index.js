...
const carouselItems = [
  {
    ...
    props: {
      ...
      photoUrl: "https://via.placeholder.com/150/003366/FFFFFF?text=KNU+Prof", // 실제 이미지로 교체
      email: "yr.kim@knu.ac.kr",
      office: "IT융복합관 405호",
      education: [
        "미국 스탠퍼드 대학교 컴퓨터과학 박사",
        "서울대학교 컴퓨터공학 석사",
        "경북대학교 컴퓨터공학 학사"
      ],
      researchInterests: [
  ...
  },
  {
    ...
    props: {
      ...
      imageUrl: "https://via.placeholder.com/800x300/2979FF/FFFFFF?text=Project+Mobility", // 실제 프로젝트 이미지로 교체
